...
>
    ...
    <button
        type="button"
        @click="accept()"
        class="self-end lg:self-auto bg-[#C09830] hover:bg-[#7A5A18] text-white font-semibold text-xs lg:text-sm px-4 py-2 rounded-full shadow-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#C8A235] focus:ring-offset-gray-900"
    >
        Entendido
    </button>
</div>
