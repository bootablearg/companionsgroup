...
.plan-card {
    ...
    background:
        ...
        linear-gradient(135deg, #C4B5FD, #F9A8D4) border-box;
}
.plan-card--badge {
    padding-bottom: 52px;
}
.plan-card:hover {
    ...
    box-shadow: 0 5px 18px rgba(124,58,237,.18);
        ...
        <div class="plan-card{{ $plan->is_featured_included ? ' plan-card--badge' : '' }}">
            ...
            <ul style="list-style:none;padding:0;margin:12px 0 0;">
                ...
                <li class="flex items-center gap-2 text-xs text-gray-600 mb-1.5">
                    <svg width="12" height="12" fill="none" stroke="#7C3AED" stroke-width="2.5" viewBox="0 0 24 24" style="flex-shrink:0;"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>
                    {{ $feat }}
                </li>
                @endforeach
            </ul>
            ...
            <span style="position:absolute;bottom:16px;left:20px;display:inline-flex;align-items:center;gap:4px;background:linear-gradient(135deg,#7C3AED,#EC4899);color:#fff;font-size:10px;font-weight:700;padding:3px 10px;border-radius:999px;letter-spacing:.03em;">
