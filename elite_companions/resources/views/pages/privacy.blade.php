...
@section('title', 'Política de Privacidad — Elite Companions Argentina')
@section('meta_description', 'Política de privacidad de Elite Companions. Conocé cómo protegemos tus datos personales y garantizamos tu privacidad en nuestra plataforma.')
@section('canonical', 'https://elitecompanions.cc/privacidad')
